...
VALUES ('moodysrating', 'sandprating', 'fitchrating', 12);
INSERT INTO rulename(name, description, json, template, sqlstr, sqlpart)
VALUES ('name', 'description', 'json', 'template', 'sqlStr', 'sqlStr');
INSERT INTO trade(account, type, buyQuantity)
VALUES ('bob', 'user', 10);
INSERT INTO Users(fullname, username, password, role)
VALUES ('Administrator', 'admin', '$2y$10$ylTc76XXRmuAW5e517YUE.Vvr0jKxqcpihugsKyjPhi/sQTA0Xu7a', 'ADMIN');
INSERT INTO Users(fullname, username, password, role)
VALUES ('User', 'user', '$2y$10$ylTc76XXRmuAW5e517YUE.Vvr0jKxqcpihugsKyjPhi/sQTA0Xu7a', 'USER');
