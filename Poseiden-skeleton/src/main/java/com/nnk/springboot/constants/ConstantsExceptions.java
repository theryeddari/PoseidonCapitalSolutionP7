...
public class ConstantsExceptions {
    ...
    public static final String BID_LIST_FIND_BY_ID = "An error occurred while finding bid list by id";
    public static final String BID_LIST_NOT_FOUND_EXCEPTION = "An error occurred while finding bid list by id";
